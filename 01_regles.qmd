...
Les règles du secret statistique sont des seuils définis que l'Insee instaure pour minimiser les risques de ré-identification tout en gardant une utilité certaine des données. Cette partie présente les règles les plus connues du SSP. Le lecteur est invité à se renseigner sur les règles à appliquer sur les données qu'il souhaite publier avant de commencer à poser le secret.
