...
Une solution pour ne pas diffuser ces cellules est de les supprimer (cacher). Cependant, uniquement supprimer les cellules touchées par le secret primaire n'est généralement pas suffisant. En effet, si les marges du tableau sont diffusées, alors les cellules sont liées entre elles par des équation. Ainsi, il faut cacher d'autres cellules pour ne pas pouvoir déduire la valeur des cellules cachées : c'est le **secret secondaire**.
