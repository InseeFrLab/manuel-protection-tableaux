# Poser le secret sur plusieurs tableaux liés {#sec-secrettableauxlies}
...
de cellules en secret. Dans ce cas-là, il est intéressant pour réduire le secret primaire de changer les
