# Présentation des outils {#sec-presentationoutils}
...
### Les valeurs trop élevées {#sec-valeurselevees}
...
#### Le nombre de caractère des feuilles {#sec-nombrecarafeuilles}
...
#### Les feuilles uniques {#sec-feuillesuniques}
...
#### Variable hiérarchique {#sec-varhrc}
...
### Les algorithmes de secret secondaire {#sec-algosecretsecondaire}
...
-   La taille maximale pour un nombre à été dépassée (voir section [-@sec-valeurselevees])
-   Le problème paraît insoluble pour Modular (voir sections [-@sec-nbmodalites] et [-@sec-algosecretsecondaire])
...
-   La taille maximale pour un nombre à été dépassée (voir section [-@sec-valeurselevees])
-   Le problème paraît insoluble pour Optimal (voir sections [-@sec-nbmodalites] et [-@sec-algosecretsecondaire])
...
-   La taille maximale pour un nombre à été dépassée (voir section [-@sec-valeurselevees])
-   Le problème paraît insoluble pour HyperCube (voir sections [-@sec-nbmodalites])
...
-   Voir [-@sec-algosecretsecondaire] et tester avec un autre algorithme
